...
The following code snippit shows that the data was downloaded, unzipped and the csv file extracted. The data was loaded into R with no transformations done to the data. MAKE THE FOLLOWING CODE SNIPPIT NOT RUN
```{r}
